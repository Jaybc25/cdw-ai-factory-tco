...
const ALL_CLOUD_GPU_RATES = {
  AWS: {
    ...
    GB200: { od: 27.50, conf: "QUOTE", note: "Public AWS GB200 On-Demand rate not verified as of 2026-09-01; planning rate shown, confirm current quote" },
    GB300: { od: 30.00, conf: "QUOTE", note: "Public AWS GB300 On-Demand rate not verified as of 2026-09-01; planning rate shown, confirm current quote" },
  },
  Azure: {
    ...
    "B200-class": { od: 27.04, conf: "QUOTE", note: "Public Azure B200 Pay-As-You-Go rate not verified as of 2026-09-01; planning rate shown, confirm current quote" },
    B300: { od: 15.00, conf: "QUOTE", note: "Public Azure B300 Pay-As-You-Go rate not verified as of 2026-09-01; planning rate shown, confirm current quote" },
    GB200: { od: 27.04, conf: "LISTED", note: "Standard_ND128isr_NDR_GB200_v6 Linux $108.16/4, Azure Retail Prices API, East US/West US 3" },
    GB300: { od: 40.00, conf: "QUOTE", note: "Public Azure GB300 Pay-As-You-Go rate not verified as of 2026-09-01; planning rate shown, confirm current quote" },
  },
  GCP: {
    ...
    B300: { od: 15.00, conf: "QUOTE", note: "Public GCP B300 On-Demand rate not verified as of 2026-09-01; planning rate shown, confirm current quote" },
    GB200: { od: 27.50, conf: "QUOTE", note: "Public GCP GB200 On-Demand rate not verified as of 2026-09-01; planning rate shown, confirm current quote" },
    GB300: { od: 30.00, conf: "QUOTE", note: "Public GCP GB300 On-Demand rate not verified as of 2026-09-01; planning rate shown, confirm current quote" },
  },
  OCI: {
  ...
  CoreWeave: {
    ...
    B300: { od: 8.00, conf: "QUOTE", note: "CoreWeave public On-Demand price is Contact sales; planning rate shown, confirm current quote" },
    GB200: { od: 10.50, conf: "LISTED", note: "North America On-Demand $42.00/4" },
    GB300: { od: 12.00, conf: "QUOTE", note: "CoreWeave public On-Demand price is Contact sales; planning rate shown, confirm current quote" },
  },
};
