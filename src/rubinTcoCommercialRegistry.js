...
export const RUBIN_TCO_COMMERCIAL_SCAFFOLD = Object.freeze({
  ...
  "DGX Vera Rubin NVL72": Object.freeze({
    ...
    includedHardwareSupportLevel: "Business Standard",
    systemPowerKW: null,
    systemPowerConfidence: "UNRESOLVED_RATED_POWER",
    systemPowerSource: "No canonical first-party rated/design rack power has been established. Keep rated power null rather than conflating facilities envelope or workload-limited scenarios with system rating.",
    phase1PlanningPowerKW: 136,
    phase1PlanningPowerConfidence: "PROVISIONAL",
    phase1PlanningPowerEditable: true,
    phase1PlanningPowerSource: "NVIDIA MaxLPS Vera Rubin NVL72 representative scenario: 136 kW provisioned rack power.",
    maxLpsScenarioPowerKW: 101,
    maxLpsScenarioPowerNote: "NVIDIA MaxLPS representative inference scenario; only use when customer explicitly models MaxLPS/power-limited operation.",
    facilityCabinetTdpKW: 330,
    facilityCabinetTdpNote: "NVIDIA facilities/reference-design cabinet TDP envelope; not used as normal Phase 1 operating power.",
    optionalSoftware: Object.freeze({
    ...
    tcoEnabled: false,
    tcoBlockers: Object.freeze([
      "Customer-facing TCO still needs wiring that preserves 136 kW as a PROVISIONAL editable planning value rather than a canonical rated-power claim.",
      "Rubin-specific fabric/infrastructure planning cost remains an editable Phase 1 estimate until replaced by quote/Phase 2 design.",
      "Economic professional-services/installation cost remains an editable Phase 1 estimate/quote-required input.",
      "Optional NVIDIA AI Enterprise and Mission Control treatment must remain an explicit modeling choice.",
      "Quote-only + MOQ 2 treatment requires explicit disclosure in customer-facing TCO.",
    ]),
