      ...
      <div style={{ maxWidth: 560, margin: "0 auto", padding: "18px 14px 60px" }}>
        ...
        <div style={{ marginBottom: 14 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
            ...
            <div style={{ ...mono, fontSize: 10, color: C.sub, letterSpacing: 1.5 }}>AI FACTORY · PROTOTYPE v2.4</div>
          </div>
            ...
            <div style={{ marginTop: 14 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2px 14px", fontSize: 11 }}>
                {[
                  ...
                  ["Engine version", "v2.4 (engine unchanged from v2.3; workbook parity release — B300 offered here with EST-flagged rates and provisional index, blocked in the reference workbook pending benchmark factors)"],
                ].map(([k, v]) => (
