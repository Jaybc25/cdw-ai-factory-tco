...
const FIXTURES = {
  "qwen3.8-27b": { stateType: "deltanet-attention-hybrid", totalBytes: 691798016, fixedBytes: 154927104 },
  "deepseek-v4-flash-0731": { stateType: "deepseek-v4-compressed-attention", totalBytes: 62050816, fixedBytes: 53760 },
  "deepseek-v4-pro-0813": { stateType: "deepseek-v4-compressed-attention", totalBytes: 88747008, fixedBytes: 76800 },
  "nemotron-3-super-120b-a12b": { stateType: "mamba-attention-hybrid", totalBytes: 238157824, fixedBytes: 171048960 },
};
...
test("test-only hybrid harness stays out of navigation while activated models are customer-visible", async ({ page }) => {
  await page.goto("/gpu-sizing", { waitUntil: "domcontentloaded" });
  for (const id of Object.keys(FIXTURES)) await expect.poll(() => page.locator(`option[value="${id}"]`).count()).toBeGreaterThan(0);
