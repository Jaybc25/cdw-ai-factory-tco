...
assert.ok(guided.includes("Deployed private-AI fleet"));
assert.ok(guided.includes("GPUs credited for throughput"));
assert.ok(guided.includes("Conservative throughput treatment:"));
assert.ok(guided.includes("No additional throughput is assumed without scaling evidence."));
